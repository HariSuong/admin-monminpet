 ...
 *   "attribute_id": "6",
    ...
    "image": ""
 */
const UpdateFaqForm = ({ faq }: { faq: FaqItem }) => {
  ...
  async function onSubmit(values: CreateFaqBodyType) {
    ...
    try {
      const result = await faqApiRequest.updateFaqs(faq.id, submitData)
      showToast({
        severity: 'success',
        ...
        <Grid container justifyContent='space-between' spacing={2}>
          ...
          <Grid size={12}>
            <Button
              ...
              type='submit'
              disabled={loading}>
              {loading ? 'Đang cập nhật faq...' : 'Cập nhật faq'}
            </Button>
          </Grid>
        </Grid>
      </div>
